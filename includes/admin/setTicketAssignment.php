...
if($_POST['action'] != 'setAssignAgentMultiple'){
...
$sql="select body,attachment_ids FROM {$wpdb->prefix}wpsp_ticket_thread WHERE ticket_id=".$ticket_id.' ORDER BY create_time ASC';
...
$values=apply_filters('wpsp_setticketassignment_before_update_ticket',$values,$ticket);
$wpdb->update($wpdb->prefix.'wpsp_ticket',$values,array('id'=>$ticket_id));
do_action('wpsp_after_ticket_assign_to_staff',$ticket);
/*
