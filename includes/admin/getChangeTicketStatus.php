...
<input type="hidden" id="wpsp_change_ticket_status_nonce" value="<?php echo wp_create_nonce($ticket_id);?>" />

<button class="btn btn-success changeTicketSubBtn" onclick="openTicket(<?php echo $ticket_id?>);"><?php _e('Cancel','wp-support-plus-responsive-ticket-system');?></button>
<button class="btn btn-success changeTicketSubBtn" onclick="setChangeTicketStatus(<?php echo $ticket_id;?>);"><?php _e('Save Changes','wp-support-plus-responsive-ticket-system');?></button>
