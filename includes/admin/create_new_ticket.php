...
<?php	}?>
	...
	<input type="hidden" id="guest_email" name="guest_email" value="">
        <input type="hidden" name="wpsp_nocaptcha_token" value="<?php echo wp_create_nonce('wpsp_nocaptcha_token');?>">
...
function replyonclick(cid){
    ...
    CKEDITOR.instances["create_ticket_body"].insertText(x.innerText); 
    jQuery("#psmwpsp").hide();
}
