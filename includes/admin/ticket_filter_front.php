...
<?php 
    ...
    ?><input id="filter_by_category_front" type="hidden" name="filter_by_category_front" value=""/><?php
}
...
<?php 
    ...
    ?><input id="filter_by_no_of_ticket_front" type="hidden" name="filter_by_no_of_ticket_front" value=""/><?php
}
...
<?php
    ...
    ?><input id="filter_by_search_front" type="hidden" name="filter_by_search_front" value=""/>
        <input id="filter_by_selection_front" type="hidden" name="filter_by_selection_front" value=""/>
    <?php
}
?>
